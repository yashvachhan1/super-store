                ...
                <div className="flex-1 px-8 pb-12">
                    <Link href={`/journal/${blogs[0].slug}`} className="group relative block w-full h-full rounded-[3rem] overflow-hidden bg-gray-100 shadow-2xl">
                        {blogs[0].image ? (
                            ...
                            <div className="w-full h-full bg-zinc-900 flex items-center justify-center text-xl font-black uppercase tracking-widest italic text-white/20">Aesthetic.</div>
                        )}
                                ...
                                >
                                    <Link href={`/journal/${blog.slug}`} className="block relative aspect-[4/3] rounded-[2rem] overflow-hidden bg-gray-100 mb-8">
                                        {blog.image ? (
                                            ...
                                            <div className="w-full h-full bg-gray-100 flex items-center justify-center text-[10px] font-bold text-gray-300">NO IMAGE</div>
                                        )}
                                    </Link>
