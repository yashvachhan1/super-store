        ...
        <div className="absolute inset-0 z-0 scale-105">
          <div className="w-full h-full bg-black">
            <Image
              ...
              alt="Hero Image"
              fill
              className="object-cover brightness-[0.85] opacity-60"
              priority
      ...
      <section className="py-32 px-8 max-w-[1600px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative aspect-square overflow-hidden bg-gray-50 rounded-2xl group">
            <Image src="/lifestyle.png" alt="Lifestyle" fill className="object-cover group-hover:scale-110 transition-transform duration-[3s]" onError={(e) => (e.currentTarget.style.display = 'none')} />
              ...
              <Link href={`/shop/${prod.id}`} key={prod.id}>
                ...
                >
                  <div className="relative aspect-[4/5] bg-gray-50 overflow-hidden mb-6 rounded-2xl">
                    {prod.images?.[0] ? (
                      <Image src={prod.images[0]} alt={prod.name} fill className="object-cover group-hover:scale-110 transition-transform duration-700 ease-out" />
                    ) : (
                      <div className="w-full h-full bg-gray-100 flex items-center justify-center text-[10px] font-bold text-gray-300">NO IMG</div>
                    )}
