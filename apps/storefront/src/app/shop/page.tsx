                                ...
                                {filteredProducts.map((prod) => (
                                    <div key={prod.id} className="relative group">
                                        <Link href={`/shop/${prod.id}`}>
                                            ...
                                            >
                                                <div className="relative aspect-[4/5] bg-gray-50 overflow-hidden mb-6 rounded-[2.5rem]">
                                                    {prod.images?.[0] ? (
                                                        <Image
                                                            src={prod.images[0]}
                                                            alt={prod.name}
                                                        ...
                                                        <div className="w-full h-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-300 uppercase italic">No Visual</div>
                                                    )}
