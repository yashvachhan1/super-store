                            ...
                            >
                                <div className="relative aspect-[4/5] bg-gray-50 overflow-hidden mb-6 rounded-3xl">
                                    {prod.img ? (
                                        ...
                                        <div className="w-full h-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-300 uppercase tracking-widest italic">No Visual Data</div>
                                    )}
